...
IF EXISTS (
  ...
  WHERE SPECIFIC_SCHEMA = N'EC' AND SPECIFIC_NAME = N'sp_Sharepoint_Upload_Bingo_Hattiesburg' 
)
   DROP PROCEDURE [EC].[sp_Sharepoint_Upload_Bingo_Hattiesburg]
GO
...
--	Description:    Extracts previous month Hattiesburg Bingo logs for upload to Sharepoint
...
--	=====================================================================
CREATE PROCEDURE [EC].[sp_Sharepoint_Upload_Bingo_Hattiesburg] 
AS
...
BEGIN TRY
	...
	SET TRANSACTION ISOLATION LEVEL READ COMMITTED
	  ...
	  DECLARE @EmployeeSite nvarchar(30) = 'Hattiesburg',
