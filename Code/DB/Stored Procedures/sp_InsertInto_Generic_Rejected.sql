...
BEGIN
UPDATE [EC].[Generic_Coaching_Stage]
SET [Reject_Reason]= CASE WHEN LEFT(Report_Code,LEN(Report_Code)-8) = 'DTT' 
...
BEGIN
UPDATE [EC].[Generic_Coaching_Stage]
SET [Reject_Reason]= CASE WHEN LEFT(Report_Code,LEN(Report_Code)-8) = 'SEA'
...
WAITFOR DELAY '00:00:00.03' -- Wait for 3 ms
 ...
 BEGIN
 UPDATE [EC].[Generic_Coaching_Stage]
SET [Reject_Reason]= CASE WHEN LEFT(Report_Code,LEN(Report_Code)-8) = 'OTH'
