/*
sp_ShortCalls_Get_SupReviewDetails(01).sql
...
IF EXISTS (
  SELECT * 
   ...
   WHERE SPECIFIC_SCHEMA = N'EC'
     AND SPECIFIC_NAME = N'sp_ShortCalls_Get_SupReviewDetails' 
)
   DROP PROCEDURE [EC].[sp_ShortCalls_Get_SupReviewDetails]
GO
...
--	Description: *	This procedure takes a log id and return the short calls for that log for Manager review
--  Last Modified By:
--  Last Modified Date: 
--  Initial revision. New process for short calls. TFS 14108 - 06/25/2019
--	=====================================================================

CREATE PROCEDURE [EC].[sp_ShortCalls_Get_SupReviewDetails] @intLogId BIGINT
AS
...
END --sp_ShortCalls_Get_SupReviewDetails
GO
