/*
sp_SelectCoaching4QNBingo(01).sql
...
--	Description: 	   This procedure queries db for Quality Now Bingo feed records to send out mail
--  Last Updated By: Susmitha Palacherla
--  Initial Revision. TFS 15063 - 08/12/2019
--  	=====================================================================
CREATE PROCEDURE [EC].[sp_SelectCoaching4QNBingo]
AS
...
SELECT distinct b.CoachingID numID	
	...
	,''Bingo stickers for the month'' strSubject
...
JOIN [EC].[Coaching_Log_Quality_Now_Bingo] b ON b.CoachingId = cl.CoachingId 
WHERE cl.strReportCode like ''BQN%''
