...
IF EXISTS (
  ...
  WHERE SPECIFIC_SCHEMA = N'EC' AND SPECIFIC_NAME = N'sp_Sharepoint_Upload_Bingo_London' 
)
   DROP PROCEDURE [EC].[sp_Sharepoint_Upload_Bingo_London]
GO
...
--	Description:    Extracts previous month London Bingo logs for upload to Sharepoint.
...
--	=====================================================================
CREATE PROCEDURE [EC].[sp_Sharepoint_Upload_Bingo_London] 
AS
...
BEGIN TRY
  ...
  DECLARE @EmployeeSite nvarchar(30) = 'London',
