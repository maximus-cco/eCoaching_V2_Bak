...
IF EXISTS (
  ...
  WHERE SPECIFIC_SCHEMA = N'EC' AND SPECIFIC_NAME = N'sp_Sharepoint_Upload_Bingo_Tampa' 
)
   DROP PROCEDURE [EC].[sp_Sharepoint_Upload_Bingo_Tampa]
GO
...
BEGIN TRY
	...
	SET TRANSACTION ISOLATION LEVEL READ COMMITTED
	  ...
	  DECLARE @EmployeeSite nvarchar(30) = 'Tampa',
