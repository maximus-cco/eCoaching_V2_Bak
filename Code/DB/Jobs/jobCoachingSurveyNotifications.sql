...
-------------------------------------------------------------------
-- Creates the CoachingSurveyNotifications job for the desired environment
...
DECLARE @jobName nvarchar(100) = N'CoachingSurveyNotifications'
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@jobName, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Sends Notifications for newly generated eCoaching Surveys.', 
...
-------------------------------------------------------------------
-- Object 1:  Step [Survey Notifications ]
-------------------------------------------------------------------
