...
-------------------------------------------------------------------
-- Creates the CoachingBingoNotifications job for the desired environment
...
DECLARE @jobName nvarchar(100) = N'CoachinBingoNotifications'
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@jobName, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Sends Notifications for newly generated Bingo eCoaching logs.', 
...
DECLARE @scriptName nvarchar(100) = N'Notifications_Bingo_' + @environment + N'.vbs"' 
