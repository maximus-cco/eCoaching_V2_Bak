...
-------------------------------------------------------------------
-- Creates the CoachingNotifications job for the desired environment
...
DECLARE @jobName nvarchar(100) = N'CoachingNotifications'
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@jobName, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Sends Notification when an eCoaching log has been generated from a feed file.', 
