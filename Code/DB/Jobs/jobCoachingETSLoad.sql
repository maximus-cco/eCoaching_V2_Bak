...
-------------------------------------------------------------------
-- Creates the CoachingETSLoad job for the desired environment
...
DECLARE @jobName nvarchar(100) = N'CoachingETSLoad'
DECLARE @configfileName nvarchar(100) = CONCAT(@environment + N'_', N'ETS_Coaching.dtsConfig')
...
DECLARE @packagePath nvarchar(1000) = 
			(SELECT CASE @environment WHEN 'PROD' THEN N'\\UVAAPADSQL50CCO\SSIS\Coaching\Packages\'
									  WHEN 'TEST' THEN N'\\UVAADADSQL52CCO\SSIS\Coaching\Packages\ETS_Coaching\' 
									  ELSE N'\\UVAADADSQL50CCO\SSIS\Coaching\Packages\ETS_Coaching\' END) -- Assume dev
...
-------------------------------------------------------------------
-- Object 1:  Step [Load ETS file]
-------------------------------------------------------------------
DECLARE @packageCommand nvarchar(4000) = N'/FILE "' + @packagePath + N'ETS_Coaching.dtsx" /CONFIGFILE "' + @configfilePath + @configfileName +'"  /CHECKPOINTING OFF  /REPORTING E'
