...
-------------------------------------------------------------------
-- Creates the CoachingSurveyReminders job for the desired environment
...
DECLARE @jobName nvarchar(100) = N'CoachingSurveyReminders'
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@jobName, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Sends Reminder Notifications for Surveys not completed within the required timeframe.', 
...
DECLARE @scriptName nvarchar(100) = N'Reminders_Survey_' + @environment + N'.vbs"' 
