...
,(N'UVAADADSQL52CCO', N'UAT') -- This will be a temporary test environment
...
DECLARE @serverName nvarchar(20) = 
			(SELECT CASE @environment WHEN 'PROD' THEN N'UVAAPADSQL50CCO'
									  WHEN 'UAT'  THEN N'UVAADADSQL52CCO'
									  WHEN 'TEST' THEN N'UVAADADSQL52CCO'
									  ELSE N'UVAADADSQL50CCO' END) -- Assume dev
...
DECLARE @exePath nvarchar(1000) = 
			(SELECT CASE @environment WHEN 'PROD' THEN N'\\UVAAPADSQL50CCO\SSIS\Coaching\SOIBean\'
									  WHEN 'UAT'  THEN N'\\UVAADADSQL52CCO\SSIS\Coaching\UAT\SOIBean\'
									  WHEN 'TEST' THEN N'\\UVAADADSQL52CCO\SSIS\Coaching\SOIBean\'
									  ELSE N'\\UVAADADSQL50CCO\SSIS\Coaching\SOIBean\' END) -- Assume dev
