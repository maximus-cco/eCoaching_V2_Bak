...
-------------------------------------------------------------------
-- Creates the CoachingQualityOtherLoad job for the desired environment
...
DECLARE @jobName nvarchar(100) = N'CoachingQualityOtherLoad'
DECLARE @configfileName nvarchar(100) = CONCAT(@environment + N'_', N'Quality_Other_Coaching.dtsConfig')
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@jobName, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Load Quality Other File.', 
...
DECLARE @packagePath nvarchar(1000) = 
			(SELECT CASE @environment WHEN 'PROD' THEN N'\\UVAAPADSQL50CCO\SSIS\Coaching\Packages\'
									  WHEN 'TEST' THEN N'\\UVAADADSQL52CCO\SSIS\Coaching\Packages\Quality_Other_Coaching\' 
									  ELSE N'\\UVAADADSQL50CCO\SSIS\Coaching\Packages\Quality_Other_Coaching\' END) -- Assume dev
...
-------------------------------------------------------------------
-- Object 1:  Step [Load Quality Other file]
-------------------------------------------------------------------
DECLARE @packageCommand nvarchar(4000) = N'/FILE "' + @packagePath + N'Quality_Other_Coaching.dtsx" /CONFIGFILE "' + @configfilePath + @configfileName +'"  /CHECKPOINTING OFF  /REPORTING E'
