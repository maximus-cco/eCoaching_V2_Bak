...
-------------------------------------------------------------------
-- Creates the CoachingQualityLoad job for the desired environment
...
DECLARE @jobName nvarchar(100) = N'CoachingQualityLoad'
DECLARE @configfileName nvarchar(100) = CONCAT(@environment + N'_', N'IQS_Coaching.dtsConfig')
...
DECLARE @packagePath nvarchar(1000) = 
			(SELECT CASE @environment WHEN 'PROD' THEN N'\\UVAAPADSQL50CCO\SSIS\Coaching\Packages\'
									  WHEN 'TEST' THEN N'\\UVAADADSQL52CCO\SSIS\Coaching\Packages\IQS_Coaching\' 
									  ELSE N'\\UVAADADSQL50CCO\SSIS\Coaching\Packages\IQS_Coaching\' END) -- Assume dev
...
-------------------------------------------------------------------
-- Object 1:  Step [Load Quality IQS file]
-------------------------------------------------------------------
DECLARE @packageCommand nvarchar(4000) = N'/FILE "' + @packagePath + N'IQS_Coaching.dtsx" /CONFIGFILE "' + @configfilePath + @configfileName +'"  /CHECKPOINTING OFF  /REPORTING E'
