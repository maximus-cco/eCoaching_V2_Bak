...
-------------------------------------------------------------------
-- Creates the CoachingFollowup job for the desired environment
...
DECLARE @jobName nvarchar(100) = N'CoachingFollowup'
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@jobName, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Sends Notifications for eCoaching logs ready for followup.', 
...
DECLARE @scriptName nvarchar(100) = N'Followup_' +@environment + N'.vbs"' 
