...
copy "%%a" Web.config /y
c:\windows\microsoft.net\framework\v4.0.30319\aspnet_regiis -pdf connectionStrings . 
c:\windows\microsoft.net\framework\v4.0.30319\aspnet_regiis -pdf credentialAppSettings . 
copy Web.config "%%a" /y
del Web.config
)
