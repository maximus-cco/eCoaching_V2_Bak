...
<asp:Content ID="SearchContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form-group">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="FormNameTextBox" ErrorMessage="Form name is required." EnableClientScript="false" runat="server"></asp:RequiredFieldValidator>
    </div>

    <br />
    <asp:Button ID="SearchButton" runat="server" OnClick="SearchButton_Click" Text="Search"></asp:Button>
    <br />
    <br />
    ...
    <asp:UpdatePanel ID="SearchResultUpdatePanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="ViewNameHidden" runat="server" value="" ClientIDMode="Static"></asp:HiddenField>
            <asp:GridView ID="SearchResultGridView" runat="server" CssClass="table table-hover" GridLines="None" AutoGenerateColumns="False" OnRowCommand="SearchResultGridView_RowCommand">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="DetailButton" runat="server" CommandName="viewDetail" Text="View Detail" CommandArgument='<%# Container.DataItemIndex %>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
                    ...
                    <asp:BoundField ReadOnly="True" HeaderText="Form Name" DataField="FormName"></asp:BoundField>
                    <asp:BoundField ReadOnly="True" HeaderText="Employee LAN ID" DataField="EmpLanID"></asp:BoundField>
                    <asp:BoundField ReadOnly="True" HeaderText="Employee ID" DataField="EmpID"></asp:BoundField>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HiddenField ID="LogIDHidden" runat="server" Value='<%# Eval("CoachingID") %>'></asp:HiddenField>
                            <asp:HiddenField ID="FormNameHidden" runat="server" Value='<%# Eval("FormName") %>'></asp:HiddenField>
                            <asp:HiddenField ID="SourceIDHidden" runat="server" Value='<%# Eval("SourceID") %>'></asp:HiddenField>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="testdiv">
                    <iframe id="detailFrame" width="100%" height="100%" frameborder="0"></iframe>
                </div>
