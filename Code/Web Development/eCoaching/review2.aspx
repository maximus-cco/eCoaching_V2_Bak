        ...
        <ContentTemplate>
            <asp:ListView ID="ListView2" runat="server" DataSourceID="SqlDataSource2" EnableModelValidation="True"
                ...
                <ItemTemplate>
                    ...
                    <asp:Label ID="Label100" runat="server" Text="Reviewed and acknowledged coaching opportunity on"
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    <asp:Panel ID="Panel31" runat="server" Visible="false">
        ...
        <asp:Panel ID="Panel18" runat="server">
            ...
            <asp:Label ID="Label63" runat="server" Text="Scorecard Name:" ForeColor="Black" CssClass="sidelabel"></asp:Label>&nbsp;<asp:Label
                ID="Label64" runat="server" CssClass="sidetext"></asp:Label><br />
        </asp:Panel>
