...
Public Class default2
    ...
    & "  <a href=""https://f3420-mwbp11.vangent.local/coach/default.aspx"" target=""_blank"">Please click here to open the coaching application and select the &#39;My Dashboard&#39; tab to view the below form ID for details.</a>"
            ...
            ' FormName will be generated by sp_InsertInto_Coaching_Log: eCL-EmpLanID-PrimaryKey
            SqlDataSource6.InsertParameters("nvcFormName").DefaultValue = Label17.Text 'Label160.Text '"eCL-" & lan & numCount.Text
    ...
    Protected Sub Button5_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button5.Click
        ...
        If (found < 13 AndAlso Page.IsValid) Then ' maximum reasons selected is 12
            ...
            If (warnlist.SelectedIndex = 0) Then
                ...
                ' FormName will be generated by sp_InsertInto_Warning_Log: eCL-EmpLanID-PrimaryKey
                SqlDataSource27.InsertParameters("nvcFormName").DefaultValue = Label17.Text
                If (modtype(0) = 1) Then
    ...
    Protected Sub Warning_Inserted(ByVal sender As Object, ByVal e As SqlDataSourceStatusEventArgs) Handles SqlDataSource27.Inserted
        ...
        If (e.AffectedRows > 0) Then
            strFormID = e.Command.Parameters("@nvcNewFormName").Value
        End If
    End Sub

    Protected Sub Coaching_Inserted(ByVal sender As Object, ByVal e As SqlDataSourceStatusEventArgs) Handles SqlDataSource6.Inserted
        If (e.AffectedRows > 0) Then
            strFormID = e.Command.Parameters("@nvcNewFormName").Value
        End If
    End Sub
