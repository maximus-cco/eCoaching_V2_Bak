...
; (function ($, document, window, undefined) {
	...
	$.fn.userTimeout = function (opts) {
		...
		var modal = function () {
			...
			if ($modalUI === 'bootstrap') {
				...
				if ($options.timer === true) {
					$footer = $('<div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal" id="test">' + $options.modalStayLoggedBtn + ' (<span id="countdowntimer">' + $countDownTimer + '</span>)</button></div>');
				} else {
					$footer = $('<div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal" id="test">' + $options.modalStayLoggedBtn + '</button></div>');
				}

				$logoutBtn = $('<button type="button" class="btn btn-default" data-dismiss="modal" id="logoff">' + $options.modalLogOffBtn + '</button>');
		...
		// Makes ajax call to keep session alive
