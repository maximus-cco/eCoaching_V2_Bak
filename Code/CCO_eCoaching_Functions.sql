/*
File: eCoaching_Functions.sql (01)
Date: 04/02/2014
...
/****** Object:  UserDefinedFunction [EC].[fn_intGetSiteIDFromLanID]    Script Date: 03/13/2014 15:26:40 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  UserDefinedFunction [EC].[fn_nvcGetEmpIdFromLanId]    Script Date: 03/13/2014 21:20:58 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	RETURN @nvcEmpID
END --[EC].[fn_nvcGetEmpIdFromLanId] 
GO
